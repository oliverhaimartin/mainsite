! function(a, b) {
	...
	function o() {
		...
		f.addRule(".spin-vml", "behavior:url(#default#VML)"), n.prototype.lines = function(b, c) {
			...
			if (c.shadow)
				for (k = 1; k <= c.lines; k++) m(k, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
	...
	n.defaults = {}, j(n.prototype, {
		...
		lines: function(a, b) {
			...
			}), b.shadow && e(j, i(k("#000", "0 0 4px #000"), {
				top: "2px"
